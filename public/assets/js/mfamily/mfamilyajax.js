$(document).ready(function(){
    //hiển thị thông báo thành công khi edit hoặc thêm mới
    ...
    $(window).on('load', function() {
        ...
        $("#nav-mfamily").addClass('active');

        $.ajax({
            url:"http://127.0.0.1:8000/mfamily/search",
            method:"get",
            data:{query:query},
            success:function(data){
                ...
                $.each(data.data, function(index, value){
                    ...
                    <tr class="data-table">
                        ...
                        <td>${value.family_hometown}</td>
                        <td>${value.family_anniversary}</td>
                    </tr>
                    `;
                    //đưa đoạn code này vào tr khi cần edit
                    // <td>                 
    ...
    // $(document).on('click', '#nextPageBtn', function(event){
    //     event.preventDefault();
    //     var currentPage = $(".t-body").attr('current-page');
    //     var totalPage = $("#totalPage").attr('total-page');
    //     if(parseInt(currentPage) < parseInt(totalPage)){
    //         $(".t-body").attr('current-page', parseInt(currentPage) + 1); 
    //     }
    //     var nextPage = $(".t-body").attr('current-page');
    //     fetch_data(nextPage);
    //  });
    ...
    //         $(".t-body").attr('current-page', parseInt(currentPage) - 1); 
    //     }
    //     var prevousPage = $(".t-body").attr('current-page');
    //     fetch_data(prevousPage);
    //  });

    //  $(document).on('click', '.pageNumber', function(event){
    //     event.preventDefault();
    //     var pageNumber = $(this).attr('page-number');
    //     $(".t-body").attr('current-page', pageNumber); 
    ...
    //   var _token = $("input[name=_token]").val();
    //     $.ajax({
    //       url:"http://127.0.0.1:8000/mfamily/pagination",
    //       method:"POST",
